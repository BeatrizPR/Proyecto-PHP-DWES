<?php
	ob_start(); //Para solucionar error con el header del paginado
...
<nav class="navbar navbar-expand-md navbar-light bg-light fixed-top" role="navigation">
        ...
        <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
            <li class="nav-item order-2 order-md-1"><a href="registro.php" class="nav-link" title="settings"><i class="fa fa-sign-in"> </i> Sign up </a></li>
			<li class="nav-item order-1 order-md-1"><a href="libs/form-login.php" class="nav-link" title="login"><i class="fa fa-user"> </i> Login </a></li>
